...
const CollectionChild = ({ elem, idx }: ICOLLECTION) => {
    return (
        <>
            <div
                className='w-[250px] h-[290px] bg-[#ECF0EF]  rounded-3xl relative shadow-md border border-[##ECF0EF] overflow-hidden '
                key={idx}
            >
                ...
                <img
                    src={elem.image}
                    alt='image'
                    className='max-w-[100%] h-auto transition object-cover aspect-square cursor-pointer hover:scale-125'
                />
